...
netParams.addStimSourceParams('Input_1',{'type': 'IClamp', 'delay': 7, 'dur': 10, 'amp': 10})
netParams.addStimSourceParams('Input_2',{'type': 'IClamp', 'delay': 1, 'dur': 10, 'amp':10})
netParams.addStimTargetParams('Input_1 -> S', {'source':'Input_1', 'sec':'dend', 'loc': 0.5,'delay': 0, 'conds':{'popLabel': 'Traub_pop'}})
